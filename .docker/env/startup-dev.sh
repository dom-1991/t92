...
# PM2 start
cd /var/www/html/frontend && pm2 start run_dev.sh --log=/var/www/html/web/storage/logs/web_fo.log
# cd /var/www/html/admin && pm2 start run_dev.sh --log=/var/www/html/api/storage/logs/web_admin.log
